...
public class TeacherController {
    ...
    public List<TeacherDto> getAllTeachers() {
        ...
        if (facultyAccessService.isAdmin()) {
            teachers = facultyAccessService.filterTeachersByAccess(teachers);
        }
     ...
     * Проверяется доступ к факультету преподавателя.
     *
    ...
    public TeacherDto insertTeacher(@RequestBody TeacherDto teacherDto) {
        Teacher teacherToAdd = TeacherDto.toDomain(teacherDto);
        
        // Проверка доступа для администраторов
        if (facultyAccessService.isAdmin()) {
            facultyAccessService.checkAccessToTeacher(teacherToAdd);
        }
        
        Teacher teacher = teacherService.insert(teacherToAdd);
    ...
    public void deleteTeacher(@PathVariable int id) {
        ...
        if (facultyAccessService.isAdmin()) {
            ...
            facultyAccessService.checkAccessToTeacher(teacher);
        }
